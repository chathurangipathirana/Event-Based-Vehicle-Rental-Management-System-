...
('Matara Suzuki Wagon R', 'Suzuki Wagon R', 'SP CAR-7788', 'LK-1005-WAGONR', 14000, 1800, 'available', 'Economy', 4, 'Automatic', 'Hybrid', 'Efficient city car for compact event errands and short hires.', 'https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?auto=format&fit=crop&w=900&q=80'),
('Jaffna Nissan Sunny', 'Nissan Sunny', 'NP JAF-5566', 'LK-1006-SUNNY', 16000, 2000, 'available', 'Economy', 5, 'Automatic', 'Petrol', 'Popular sedan for everyday Sri Lankan bookings and airport transfers.', 'https://images.unsplash.com/photo-1549921296-3fb9a5c61336?auto=format&fit=crop&w=900&q=80'),
('Batticaloa Honda City', 'Honda City', 'EP BAC-2233', 'LK-1007-HCITY', 21000, 2600, 'available', 'Premium', 5, 'Automatic', 'Petrol', 'Comfortable compact sedan with premium features for city events.', 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=900&q=80');
